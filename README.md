...
Partisan-SMS is based on the open-source SMS app QKSMS. P-SMS encrypt SMS messages to allows for peaceful protesters to communicate without authoritarian regimes being able to spy on them.
